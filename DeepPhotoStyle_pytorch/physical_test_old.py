...
def process_dir(depth_model, input_dir, proc_range=None):
    ...
    paths = sort(paths)
    bottom_gap = 150             #3595: b 150 side 300/300
    side_crop = [300, 300]
    with torch.no_grad():
        for idx, image_path in enumerate(paths):
            ...
            generate_point_cloud(disp_resized_np, calib_path, name_dest_im_lidar, 2)
...
#%%
input_dir = "/data/cheng443/depth_atk/videos/09-30-2021/IMG_3595"
process_dir(depth_model, input_dir, proc_range=5)
